...
$lang = array_merge($lang, array(
	...
	'WOW_GUILD_MEMBER_CHECK_CRON_RAN'	=> '<strong>WoW Guild Member Check Cron ran</strong><br/>&raquo; Deleted characters: %d (%s) | Users add to groups: %d | Users removed from groups: %d',
